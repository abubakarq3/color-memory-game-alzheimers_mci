...
public class LevelfourColorchanger : MonoBehaviour
{
    ...
    {
        // Asignar colores aleatorios al cilindro, cubo, esfera y cápsula
        ...
        Debug.Log($"Colores objetivo - Cilindro: {correctCylinderColor.color}, Cubo: {correctCubeColor.color}, Esfera: {correctSphereColor.color}, Cápsula: {correctCapsuleColor.color}");
    ...
    IEnumerator EndRound()
    {
        ...
        if (isCylinderCorrect && isCubeCorrect && isSphereCorrect && isCapsuleCorrect)
        {
